...
%cd C:\Users\Zack\Dropbox\coastal_housing\coastal_housing\model_manuscript
clear all; %close all; 
format compact; 
...
% define run times          %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
time_initialization         = 40;              % initialization/burn-in time
time_simulation             = 180;              % main model run time - usually 180
% initialization options    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
initialize_model            = true;           % include a burn-in/spin-up before model simulation
nourishoff_initialize       = false;           % nourishment off ( = true), nourishment on ( = false) turns off nourishment during initialization
...
outside_market_changepts    = [ 81  , 130 ];   % start(1) stop(2) time for outside market change
